...
void (*process_table[TAG_SORT_BINDER+1])(parse_stack_t *, context_t *) = {
    parse_stack_error,               // TAG_NONE,
    parse_stack_error,               // TAG_ERROR,
    parse_stack_process_numeral,     // TAG_NUMERAL,          
    parse_stack_process_sort,        // TAG_SORT,             
    parse_stack_process_variable,    // TAG_VARIABLE,         
    parse_stack_process_function,    // TAG_FUNCTION,         
    parse_stack_process_sort,        // TAG_SORT_CONSTRUCTOR, 
    parse_stack_process_system,      // TAG_SYSTEM,           
    parse_stack_process_symbol,      // TAG_IDENTIFIER,      
    parse_stack_process_bitvec,      // TAG_BITVEC,           
    parse_stack_process_int,         // TAG_INT,              
    parse_stack_process_decimal,     // TAG_DECIMAL,          
    parse_stack_process_term,        // TAG_TERM,             
    parse_stack_process_term_binder, // TAG_TERM_BINDER,      
    parse_stack_process_sort_binder, // TAG_SORT_BINDER,      
};
