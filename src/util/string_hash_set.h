...
/**
 * A string set is a unordered set of char pointers. We use the ash function in hash.h to create a
 * hash map with a number of buckets (64 by default) where each bucket is a linked list of strings.
*/
